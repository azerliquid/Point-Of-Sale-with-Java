                ...
                int jumlah_baris = tbkeranjang.getRowCount();
                    if (jumlah_baris == 0) {
                        ...
                        while(i < jumlah_baris){
                            statement.executeUpdate("insert into detail_belanjaan (invoice, kode_barang, harga, jumlah, sub_total) values('"+lblinvoice.getText()+"','"+tbkeranjang.getValueAt(i, 1)+"','"+tbkeranjang.getValueAt(i, 2)+"','"+tbkeranjang.getValueAt(i, 3)+"','"+tbkeranjang.getValueAt(i, 4)+"')");
                            i++;
                            }
                        JOptionPane.showMessageDialog(rootPane, "Berhasil menyimpan");
                        kasir2 log = new kasir2();
